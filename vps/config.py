...
YOUTUBE_OAUTH_REDIRECT_URI = os.environ.get("KN_YOUTUBE_OAUTH_REDIRECT_URI", "")
YOUTUBE_OAUTH_BOOTSTRAP_ENABLED = os.environ.get("KN_YOUTUBE_OAUTH_BOOTSTRAP_ENABLED", "false").lower() == "true"
