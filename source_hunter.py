...
4:{"footage_any":["measure","measurement","medical","human research","human body","physiology","health","full body","astronaut","crew","microgravity","floating","on station","research","science"],"context_any":["astronaut","crew","iss","space station","spaceflight"],"queries":["astronaut body measurement spaceflight video","astronaut human research ISS video","astronaut full body ISS 4K video","astronaut medical assessment ISS video","astronaut crew microgravity ISS 4K video","astronaut science research space station 4K video"]},
