...
4:{"footage_any":["measure","measurement","medical","human research","human body","physiology","health","full body","astronaut"],"context_any":["astronaut","crew","iss","space station","spaceflight"],"queries":["astronaut body measurement spaceflight video","astronaut human research ISS video","astronaut full body ISS 4K video","astronaut medical assessment ISS video"]},
